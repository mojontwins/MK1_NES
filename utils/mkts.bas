...
Dim Shared As Integer verbose, silent, mainIdx, cPoolIndex, tMapsIndex
...
Dim As Integer xOrg, yOrg, w, h, wMeta, hMeta, wProc, hProc, coords (8)
...
If sclpGetValue ("mode") = "tiles" Or sclpGetValue ("mode") = "mapped" Then
...
If sclpGetValue ("mode") = "mapped" Then
