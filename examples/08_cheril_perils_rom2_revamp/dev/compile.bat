...
copy /b work\palts0.h + work\palss0.h + work\palts1.h + work\palss1.h + work\palts2.h+ work\palss2.h + work\palts3.h + work\paltsgrey.h + work\palssgrey.h assets\palettes.h > nul
