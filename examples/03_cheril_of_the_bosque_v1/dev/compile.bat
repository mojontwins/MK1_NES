...
..\utils\mkts.exe in=tstitle.png pals=paltstitle.png out=tschr4.bin mode=mapped offset=0,0 size=12,1 tsmap=..\dev\assets\tiledatatitle.h label=tstitle tmapoffset=133 max=12 silent
rem 30 patterns; next offset = 133 + 30 = 163
..\utils\mkts.exe in=cutse.png pals=palcutse.png out=tschr5.bin mode=mapped offset=0,0 size=8,4 tsmap=..\dev\assets\cutsb.h label=cutsb tmapoffset=163 max=32 silent
...
..\utils\mkts.exe in=ssb-cheril.png pals=palssb.png out=sschr1.bin mode=tiles offset=0,0 size=5,4 metasize=2,3 silent
rem 120 patterns
..\utils\mkts.exe in=ssb-enems.png pals=palssb.png out=sschr2.bin mode=tiles offset=0,0 size=8,1 metasize=2,2 silent
rem 32 pattern, next 152
..\utils\mkts.exe in=logo.png pals=palssb.png out=sschr3.bin mode=chars offset=0,0 size=6,2 silent
rem 12 patterns, next 164
..\utils\mkts.exe in=heart.png pals=palssb.png out=sschr4.bin mode=chars offset=0,0 size=1,1 silent
...
echo Making map
cd ..\map
..\utils\mapcnvnes map_b.map 5 5 16 12 15 map_b packed
