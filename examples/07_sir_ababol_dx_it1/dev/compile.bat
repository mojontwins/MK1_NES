...
rem ..\utils\mkts.exe mode=pals pals=..\gfx\palcuts.png out=work\palcuts.h label=mypal_cuts silent
...
..\utils\mkts.exe in=ts.png pals=palts.png out=tschr3.bin mode=mapped offset=0,0 size=16,4 tsmap=..\dev\assets\tiledata1.h label=ts1 tmapoffset=72 silent
rem ..\utils\mkts.exe in=cuts.png pals=palcuts.png out=tschr4.bin mode=mapped offset=0,0 size=8,4 tsmap=..\dev\assets\cuts1.h label=cuts1 tmapoffset=185 max=32 silent
...
..\utils\mkts.exe in=ss.png pals=palss.png out=sschr1.bin mode=sprites tsmap=..\dev\assets\spr_pl.h offset=0,0 size=8,2 metasize=2,3 sprorg=0,-8 label=spr_pl genflipped silent
..\utils\mkts.exe in=ss.png pals=palss.png out=sschr2.bin mode=sprites tsmap=..\dev\assets\spr_en.h offset=0,6 size=8,2 metasize=2,2 sprorg=0,0 label=spr_en max=15 genflipped tmapoffset=82 genflipped silent 
..\utils\mkts.exe in=ss.png pals=palss.png out=sschr3.bin mode=sprites tsmap=..\dev\assets\spr_hs.h offset=0,10 size=8,2 metasize=2,2 sprorg=0,0 label=spr_hs max=9 tmapoffset=134 silent
...
cd ..\script
..\utils\msc3nes.exe script.spt 30
