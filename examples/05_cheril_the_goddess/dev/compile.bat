...
..\..\..\src\utils\mkts.exe in=font.png pals=palts.png out=tschr1.bin mode=chars size=32,2 silent
..\..\..\src\utils\mkts.exe in=frame.png pals=palts.png out=tschr2.bin mode=chars size=8,1 silent
..\..\..\src\utils\mkts.exe in=ts.png pals=palts.png out=tschr3.bin mode=mapped offset=0,0 size=16,4 tsmap=..\dev\assets\tiledata1.h label=ts1 tmapoffset=72 max=56 silent
..\..\..\src\utils\mkts.exe in=cuts.png pals=palcuts.png out=tschr4.bin mode=mapped offset=0,0 size=8,4 tsmap=..\dev\assets\cuts1.h label=cuts1 tmapoffset=187 max=32 silent
...
..\..\..\src\utils\mkts.exe in=ss.png pals=palss.png out=sschr1a.bin mode=sprites tsmap=..\dev\assets\spr_pla.h offset=0,0 size=8,2 metasize=2,3 sprorg=0,-8 label=spr_pla genflipped silent
...
del sschr3.bin > nul
del sschr4.bin > nul
..\..\..\src\utils\fillto.exe sschra.bin 3968

..\..\..\src\utils\mkts.exe in=ssbits.png pals=palss.png out=sschrb.bin mode=chars size=8,1 silent
