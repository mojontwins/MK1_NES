...
echo BANKS 0,1
..\..\..\src\utils\mkts.exe mode=scripted in=cut_tileset0-omv.spt out=..\dev\tileset0.chr silent

echo BANKS 2, 3
..\..\..\src\utils\mkts.exe mode=scripted in=cut_tileset1-omv.spt out=..\dev\tileset1.chr silent

echo BANKS 4,5
..\..\..\src\utils\mkts.exe mode=scripted in=cut_tileset2-omv.spt out=..\dev\tileset2.chr silent
