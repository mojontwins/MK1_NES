...
const unsigned char l_scr_ini [] = 				{ 0, 0, 0 };
const unsigned char l_ini_x [] = 				{ 10, 2, 10 };
const unsigned char l_ini_y [] = 				{ 3, 2, 2 };
const unsigned char l_map_w [] = 				{ 6, 4, 4 };
const unsigned char l_map_h [] =				{ 5, 6, 6 };
...
const unsigned char * const l_ts_tmaps [] = 	{ ts0_tmaps, ts0_tmaps, ts0_tmaps };
const unsigned char * const l_ts_pals [] = 		{ ts0_pals, ts0_pals, ts0_pals };
...
// Map data
	...
	const unsigned int * const l_map [] = 		{ map_00_scr_offsets, map_01_scr_offsets, map_02_scr_offsets };
		...
		const unsigned char * const * const l_decos [] =
												{ map_0_decos, map_1_decos, map_2_decos };
	#else
		// 0 = no decos in this level's map, 1 = decos.
		const unsigned char l_decos [] = 		{ 1, 1, 1 };
	#endif
#endif
...
#ifdef CNROM
	const unsigned char l_chr_rom_bank [] = 	{ 0, 0, 0 };
#endif
...
// Interactives
	...
	const unsigned char * const l_interactives [] = 
												{ interactives0, interactives1, interactives2 };
#endif

// Music track

const unsigned char l_music [] = 				{ MUSIC_INGAME, MUSIC_INGAME, MUSIC_INGAME };
