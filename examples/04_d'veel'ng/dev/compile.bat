...
..\..\..\src\utils\mkts.exe mode=pals pals=..\gfx\paltsb.png out=work\palbg0.h label=mypal_game_bg0 silent
..\..\..\src\utils\mkts.exe mode=pals pals=..\gfx\palssb.png out=work\palfg0.h label=mypal_game_fg0 silent
..\..\..\src\utils\mkts.exe mode=pals pals=..\gfx\paltsl.png out=work\palf0.h label=mypal_lighting_bg0 silent
..\..\..\src\utils\mkts.exe mode=pals pals=..\gfx\palssl.png out=work\palf1.h label=mypal_lighting_fg0 silent
..\..\..\src\utils\mkts.exe mode=pals pals=..\gfx\palcuts.png out=work\palcuts.h label=mypal_cuts silent
..\..\..\src\utils\mkts.exe mode=pals pals=..\gfx\palredbg.png out=work\palredbg.h label=mypal_redbg silent
...
..\..\..\src\utils\mkts.exe in=proj.png pals=palssb.png out=sschr5.bin mode=chars offset=0,0 size=8,1 silent
