...
#define PLAYER_MAX_OBJECTS		10		// Número de objetos para terminar el juego
#define PLAYER_LIFE				25		// Vida máxima (con la que empieza, además)
...
#define PLAYER_RX				16		// Fricción horizontal (32/64 = 0,5 píxels/frame^2)
