...
#define DEBUG_SCR_INI 10
#define DEBUG_INI_X 15
#define DEBUG_INI_Y 4
...
unsigned char level, game_on, game_over;
	...
	while (1) {
		...
		while (game_on) {	
			...
			if (level == 0)  {
				...
				c_map_decos = (unsigned char **) (mapa1_decos);
