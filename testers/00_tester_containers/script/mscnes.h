...
/* 0001 */ 0x68, 0x00, 0x00, 0x00, 0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
/* 0005 */ 0x61, 0x62, 0x05, 0xff, 0xed, 0x01, 0xff, 0xff, 0x06, 0xf0, 0xff, 0x86, 0x94, 0x81, 0xff, 0xff, 
/* 0006 */ 0x06, 0xf0, 0xff, 0x86, 0x5e, 0x82, 0xff, 0xff, 0x0e, 0xf0, 0xff, 0x86, 0x31, 0x83, 0x86, 0x4d, 
/* 0007 */ 0x84, 0x51, 0xb9, 0x31, 0xcf, 0x4f, 0xff, 0xff, 0x15, 0xf0, 0xff, 0x01, 0x00, 0x00, 0x01, 0x01, 
/* 0008 */ 0x04, 0x01, 0x02, 0x05, 0x01, 0x03, 0x06, 0x01, 0x04, 0x07, 0x01, 0x05, 0x00, 0xff, 0xff
};
		...
		while (!sc_terminado) {
			switch (read_byte ()) {
                ...
                case 0x61:
                    // IF JUST_INTERACTED
                    // Opcode: 61
                    sc_terminado = (!just_interacted);
                    break;
                case 0x62:
                    // IF ARG = sc_n
                    // Opciode: 62 sc_n
                    sc_terminado = (script_arg != read_vbyte ());
                    break;
				case 0xF0:
					// IF TRUE
					// Opcode: F0
			...
			while (!sc_terminado) {
				switch (read_byte ()) {
					...
					case 0x86:
						...
						sc_x = read_byte (); sc_y = read_byte ();
						containers_add ();
						break;
                    case 0xED:
                        // TEXTBOX n
                        // Opcode: 0xED sc_n
                        gp_gen = custom_texts [read_vbyte ()];
                        textbox_do ();
						break;
					case 0xF1:
						// WIN
